...
if(isset($_POST['update'])){
   ...
   $update_id = filter_var($update_id, FILTER_UNSAFE_RAW);
   $property_name = $_POST['property_name'];
   $property_name = filter_var($property_name, FILTER_UNSAFE_RAW);
   $price = $_POST['price'];
   $price = filter_var($price, FILTER_UNSAFE_RAW);
   $deposite = $_POST['deposite'];
   $deposite = filter_var($deposite, FILTER_UNSAFE_RAW);
   $address = $_POST['address'];
   $address = filter_var($address, FILTER_UNSAFE_RAW);
   $offer = $_POST['offer'];
   $offer = filter_var($offer, FILTER_UNSAFE_RAW);
   $type = $_POST['type'];
   $type = filter_var($type, FILTER_UNSAFE_RAW);
   $status = $_POST['status'];
   $status = filter_var($status, FILTER_UNSAFE_RAW);
   $furnished = $_POST['furnished'];
   $furnished = filter_var($furnished, FILTER_UNSAFE_RAW);
   $bhk = $_POST['bhk'];
   $bhk = filter_var($bhk, FILTER_UNSAFE_RAW);
   $bedroom = $_POST['bedroom'];
   $bedroom = filter_var($bedroom, FILTER_UNSAFE_RAW);
   $bathroom = $_POST['bathroom'];
   $bathroom = filter_var($bathroom, FILTER_UNSAFE_RAW);
   $balcony = $_POST['balcony'];
   $balcony = filter_var($balcony, FILTER_UNSAFE_RAW);
   $carpet = $_POST['carpet'];
   $carpet = filter_var($carpet, FILTER_UNSAFE_RAW); 
   $age = $_POST['age'];
   $age = filter_var($age, FILTER_UNSAFE_RAW);
   $total_floors = $_POST['total_floors'];
   $total_floors = filter_var($total_floors, FILTER_UNSAFE_RAW);
   $room_floor = $_POST['room_floor'];
   $room_floor = filter_var($room_floor, FILTER_UNSAFE_RAW);
   $loan = $_POST['loan'];
   $loan = filter_var($loan, FILTER_UNSAFE_RAW);
   $description = $_POST['description'];
   $description = filter_var($description, FILTER_UNSAFE_RAW);

   if(isset($_POST['lift'])){
      $lift = $_POST['lift'];
      $lift = filter_var($lift, FILTER_UNSAFE_RAW);
   }else{
      $lift = 'no';
   }
   if(isset($_POST['security_guard'])){
      $security_guard = $_POST['security_guard'];
      $security_guard = filter_var($security_guard, FILTER_UNSAFE_RAW);
   }else{
      $security_guard = 'no';
   }
   if(isset($_POST['play_ground'])){
      $play_ground = $_POST['play_ground'];
      $play_ground = filter_var($play_ground, FILTER_UNSAFE_RAW);
   }else{
      $play_ground = 'no';
   }
   if(isset($_POST['garden'])){
      $garden = $_POST['garden'];
      $garden = filter_var($garden, FILTER_UNSAFE_RAW);
   }else{
      $garden = 'no';
   }
   if(isset($_POST['water_supply'])){
      $water_supply = $_POST['water_supply'];
      $water_supply = filter_var($water_supply, FILTER_UNSAFE_RAW);
   }else{
      $water_supply = 'no';
   }
   if(isset($_POST['power_backup'])){
      $power_backup = $_POST['power_backup'];
      $power_backup = filter_var($power_backup, FILTER_UNSAFE_RAW);
   }else{
      $power_backup = 'no';
   }
   if(isset($_POST['parking_area'])){
      $parking_area = $_POST['parking_area'];
      $parking_area = filter_var($parking_area, FILTER_UNSAFE_RAW);
   }else{
      $parking_area = 'no';
   }
   if(isset($_POST['gym'])){
      $gym = $_POST['gym'];
      $gym = filter_var($gym, FILTER_UNSAFE_RAW);
   }else{
      $gym = 'no';
   }
   if(isset($_POST['shopping_mall'])){
      $shopping_mall = $_POST['shopping_mall'];
      $shopping_mall = filter_var($shopping_mall, FILTER_UNSAFE_RAW);
   }else{
      $shopping_mall = 'no';
   }
   if(isset($_POST['hospital'])){
      $hospital = $_POST['hospital'];
      $hospital = filter_var($hospital, FILTER_UNSAFE_RAW);
   }else{
      $hospital = 'no';
   }
   if(isset($_POST['school'])){
      $school = $_POST['school'];
      $school = filter_var($school, FILTER_UNSAFE_RAW);
   }else{
      $school = 'no';
   }
   if(isset($_POST['market_area'])){
      $market_area = $_POST['market_area'];
      $market_area = filter_var($market_area, FILTER_UNSAFE_RAW);
   }else{
      $market_area = 'no';
   }

   $old_image_01 = $_POST['old_image_01'];
   $old_image_01 = filter_var($old_image_01, FILTER_UNSAFE_RAW);
   $image_01 = $_FILES['image_01']['name'];
   $image_01 = filter_var($image_01, FILTER_UNSAFE_RAW);
   ...
   $old_image_02 = filter_var($old_image_02, FILTER_UNSAFE_RAW);
   $image_02 = $_FILES['image_02']['name'];
   $image_02 = filter_var($image_02, FILTER_UNSAFE_RAW);
   ...
   $old_image_03 = filter_var($old_image_03, FILTER_UNSAFE_RAW);
   $image_03 = $_FILES['image_03']['name'];
   $image_03 = filter_var($image_03, FILTER_UNSAFE_RAW);
   ...
   $old_image_04 = filter_var($old_image_04, FILTER_UNSAFE_RAW);
   $image_04 = $_FILES['image_04']['name'];
   $image_04 = filter_var($image_04, FILTER_UNSAFE_RAW);
   ...
   $old_image_05 = filter_var($old_image_05, FILTER_UNSAFE_RAW);
   $image_05 = $_FILES['image_05']['name'];
   $image_05 = filter_var($image_05, FILTER_UNSAFE_RAW);
