         ...
         <div class="flex">
            ...
            <div class="box">
               ...
               <option value="5000">5k</option>
                  ...
                  <option value="4000000">40m</option>
                  <option value="4000000">40m</option>
                  <option value="5000000">50m</option>
                  <option value="6000000">60m</option>
                  <option value="7000000">70m</option>
                  <option value="8000000">80m</option>
                  <option value="9000000">90m</option>
               </select>
            </div>
            <div class="box">
               <p>Maximum budget</p>
...
if(isset($_POST['h_search'])){
   ...
   $h_location = filter_var($h_location, FILTER_UNSAFE_RAW);
   $h_type = $_POST['h_type'];
   $h_type = filter_var($h_type, FILTER_UNSAFE_RAW);
   $h_offer = $_POST['h_offer'];
   $h_offer = filter_var($h_offer, FILTER_UNSAFE_RAW);
   $h_min = $_POST['h_min'];
   $h_min = filter_var($h_min, FILTER_UNSAFE_RAW);
   $h_max = $_POST['h_max'];
   $h_max = filter_var($h_max, FILTER_UNSAFE_RAW);
   ...
   $min = $_POST['min'];
   $min = filter_var($min, FILTER_UNSAFE_RAW);
   $max = $_POST['max'];
   $max = filter_var($max, FILTER_UNSAFE_RAW);
   $status = $_POST['status'];
