...
<div class="home">
   ...
   <section class="center">
      ...
      <form action="search.php" method="post">
         <h3>Let's find your Dream..</h3>
         <div class="box">
            <p>Location</p>
            <input type="text" name="h_location" required maxlength="100" pmeholder="enter city name" class="input">
         </div>
         <div class="flex">
            <div class="box">
               <p>Property Type</p>
         ...
         <input type="submit" value="Search" name="h_search" class="btn">
      </form>
